Shader "Apex/Avatar/Standard"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                ApexSurfaceData s = ApexAvatarBuildSurface(i, _BaseMap, _BaseMap_ST, _BaseColor, _NormalMap, _NormalMap_ST, _NormalScale, _MaskMap, _MaskMap_ST, _EmissionColor);
                ApexLightingData l = ApexBuildMainLight(i, s);
                half3 color = ApexLambert(s, l) + s.emission;
                color = ApexAvatarFinish(color, s, i, _SpectraAmount);
