Shader "Apex/World/Standard"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                ApexSurfaceData s = ApexWorldBuildSurface(i, _BaseMap, _BaseMap_ST, _BaseColor, _NormalMap, _NormalMap_ST, _NormalScale, _MaskMap, _MaskMap_ST, _EmissionColor);
                ApexLightingData l = ApexBuildMainLight(i, s);
                half3 color = ApexLambert(s, l) + s.emission;
                color = ApexWorldFinish(color, s, i, _SpectraAmount);
