Shader "Apex/Water/PoolLite"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                ApexSurfaceData s = ApexWaterBuildSurface(i, _BaseMap, _BaseMap_ST, _BaseColor, _NormalMap, _NormalMap_ST, _NormalScale, _MaskMap, _MaskMap_ST, _EmissionColor);
                ApexLightingData l = ApexBuildMainLight(i, s);
                half3 color = ApexLambert(s, l) + s.emission;
                color = ApexWaterFinish(color, s, i, _SpectraAmount);
