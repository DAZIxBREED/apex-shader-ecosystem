Shader "Apex/Screens/VideoPanelLite"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                ApexSurfaceData s = ApexScreensBuildSurface(i, _BaseMap, _BaseMap_ST, _BaseColor, _NormalMap, _NormalMap_ST, _NormalScale, _MaskMap, _MaskMap_ST, _EmissionColor);
                ApexLightingData l = ApexBuildMainLight(i, s);
                half3 color = ApexLambert(s, l) + s.emission;
                color = ApexScreensFinish(color, s, i, _SpectraAmount);
